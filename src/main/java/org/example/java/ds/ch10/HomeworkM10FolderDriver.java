...
public class HomeworkM10FolderDriver {
    ...
    public static void printFolderContentsWithStack(Folder topFolder) {
        ...
        while (!folderStack.isEmpty()) {
            ...
            int indentationIndex = indentationStack.pop();
            ...
            List<Folder> subfolderList = currentFolder.getSubFolders();

            for (int i = subfolderList.size() - 1; i >= 0; i--) {
                folderStack.push(subfolderList.get(i));
                indentationStack.push(indentationIndex + 1);
            }
        }
    }
